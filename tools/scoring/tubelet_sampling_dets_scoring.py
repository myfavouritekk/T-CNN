...
from vdetlib.vdet.tubelet_cls import scoring_tracks, rcnn_sampling_dets_scoring
...
if __name__ == '__main__':
    ...
    rcnn_sc = lambda vid_proto, track_proto, net, class_idx: \
        rcnn_sampling_dets_scoring(vid_proto, track_proto, det_proto,
            net, class_idx, args.rcnn_model,
            args.overlap_thres, save_feat=args.save_feat, save_all_sc=args.save_all_sc)
    rcnn_sc.__name__ = "rcnn_sampling_dets_{}".format(
